...
{  
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            Sophus::SE3f Tcw_SE3 = SLAM.TrackMonocular(im,tframe); // TODO change to monocular_inertial

            if (!Tcw_SE3.matrix().isZero()) {

              Eigen::Vector3f tcw = Tcw_SE3.translation(); // Extract translation vector

              std::cout << "Frame " << ni << " | Timestamp: " << tframe << " | Translation (tcw): ";
